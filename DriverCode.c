...
void pwd(char* argument){
	if(argument!=NULL){
		if(strcmp(argument,"-L")==0){
			...
			FILE* help=fopen("/home/bhartrihari/Desktop/os/project/My-Shell/pwdhelp.txt","r");
			char out[1000];
...
void history(char* argument){
	if(argument==NULL){
		FILE* his=fopen("/home/bhartrihari/Desktop/os/project/My-Shell/historystore.txt","r");
		char out[1000];
		int line=0;						
		//to read history
		...
		//to clear history
			FILE* his=fopen("/home/bhartrihari/Desktop/os/project/My-Shell/historystore.txt","w");
			fclose(his);
			historyLines=0;
		}
		...
		//to add argument after -s to another line in history
			argument=strtok(NULL," ");
			FILE* his=fopen("/home/bhartrihari/Desktop/os/project/My-Shell/historystore.txt","a");
			while(argument!=NULL){
			...
			FILE* help=fopen("/home/bhartrihari/Desktop/os/project/My-Shell/historyhelp.txt","r");
			char out[1000];
			while(fgets(out,sizeof(out),help)!=NULL){
				fputs(out,stdout);
			}
...
void callExternalCommand(char* token,char input[]){
	...
	if(strcmp(token,"ls")==0){
		token=strtok(NULL," ");
		execl("/home/bhartrihari/Desktop/os/project/My-Shell/ls",token,NULL);
	}
	else if(strcmp(token,"cat")==0){
		token=strtok(NULL," ");
		execl("/home/bhartrihari/Desktop/os/project/My-Shell/cat",token,input,NULL);
	}
	else if(strcmp(token,"date")==0){
		token=strtok(NULL," ");
		
		execl("/home/bhartrihari/Desktop/os/project/My-Shell/date",token,NULL);
	}
	else if(strcmp(token,"rm")==0){
		token=strtok(NULL," ");
		execl("/home/bhartrihari/Desktop/os/project/My-Shell/rm",token,input,NULL);
		
	}
	else if(strcmp(token,"mkdir")==0){
		token=strtok(NULL," ");
		execl("/home/bhartrihari/Desktop/os/project/My-Shell/mkdir",token,input,NULL);
...
void callHelp(){
	FILE* help=fopen("/home/bhartrihari/Desktop/os/project/My-Shell/help.txt","r");
	char out[1000];
	while(fgets(out,sizeof(out),help)!=NULL){
		fputs(out,stdout);
	}
...
int main(int arg,char const *argc[]){
	...
	printf("Welcome to BHARTRIHARI 's shell\n");
